...
function Freelance() {
  ...
  const projects = [
    ...
    },
    {
      ...
      problem: 'Empresa de plásticos precisava de uma presença digital moderna para showcase de produtos industriais.',
    ...
    },
    {
      ...
      problem: 'Cliente necessitava de sistema para gestão de voos e controle administrativo.',
